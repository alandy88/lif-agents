...
export function createAgent(profile) {
...
const AUTH_SHIM = {
    ...
    claude: `[ -z "$CLAUDE_CREDENTIALS_JSON" ] || ` +
 ...
 */
export function providerPreflight(runProfiles) {
...
//# sourceMappingURL=provider-setup.mjs.map