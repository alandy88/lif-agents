 ...
 */
export function checkOffTask(body, index) {
    let seen = 0;
    return body.replace(TASK_LINE, (line, box) => {
        seen += 1;
        if (seen !== index || box !== " ")
            return line;
...
export function taskDoneTrailer(index) {
 ...
 * not match.
 */
export function parseTaskDoneTrailers(logStdout) {
 ...
 */
export function renderTaskList(tasks, done) {
    return tasks
        .map((task, i) => {
        const index = i + 1;
 ...
 */
export function stripTaskSection(body) {
...
//# sourceMappingURL=task-list.mjs.map