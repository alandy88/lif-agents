 ...
 */
export function defangShellExpansion(text) {
 ...
 */
export function defangPromptArgs(args) {
    return Object.fromEntries(Object.entries(args).map(([key, value]) => [key, defangShellExpansion(value)]));
}
//# sourceMappingURL=defang.mjs.map