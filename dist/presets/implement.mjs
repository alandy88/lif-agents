...
import { forwardedEnvKeys, MIXED_PROFILE_NAME, resolvePhases, } from "../lib/profiles.mjs";
...
export async function runIssue(config, run, issueNumber, issue, issueSource) {
    ...
    try {
        ...
        const prompt = (name) => templatePath(`implement/${name}`, { overrideDir: config.templateDir });
        ...
        if (created.exitCode === 0)
            return { prUrl: created.stdout.trim() };
